...
export default function LoginScreen() {
  ...
  const handleLogin = async () => {
    if (!regnumber.trim()) {
      Alert.alert('Missing Info', 'Please enter your registration number.');
      return;
    }
    ...
    <ThemedView style={styles.container}>
      ...
      >
        ...
        <ThemedText style={styles.noteText}>
          Note: Ensure you select carefully and vote for your choice candidates.
...
const styles = StyleSheet.create({
  ...
  noteText: { marginTop: 30, color: '#e60a0a', fontSize: 14, padding: 15, textAlign: 'center' },
});
